...
When an Opportunity is closed won, automatically update Account status to “Customer”.

3. Send Welcome Email

After a new Contact is created, send a welcome email automatically.

4. Prevent Duplicate Records

A trigger checks if a customer email already exists before insert.
...
Get all contacts whose last name is “Smith”.
...
Get all accounts created today.
...
Get opportunities with amount greater than 5000.
...
Get all leads with status “Open”.
...
When a lead is created, the system can assign it to a sales representative instantly.
